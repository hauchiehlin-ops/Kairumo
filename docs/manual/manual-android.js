...
window.KAIRUMO_MANUAL = {
  ...
  "zh-Hant": {
    ...
    "ui": {
      ...
      "version": "適用版本 v4.4.0（build 54）· 2026 年 9 月 19 日",
      "tocTitle": "目錄",
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "桌機版視窗左上角會顯示版本號（例如 Kairumo v4.4.0），回報問題時請附上它。"
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "怎麼回報問題？",
            "請附上桌機版視窗左上角顯示的版本號（例如 Kairumo v4.4.0）與操作步驟。"
          ],
          [
            "同一本筆記可以混用不同的頁面格式嗎？",
  ...
  "en": {
    ...
    "ui": {
      ...
      "version": "For version 4.4.0 (build 54) · 19 September 2026",
      "tocTitle": "Contents",
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "On desktop the window title shows the version (for example Kairumo v4.4.0) — include it when you report a problem."
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            ...
            "Include the version shown in the desktop window title (for example Kairumo v4.4.0) and the steps you took."
          ],
          [
  ...
  "zh-Hans": {
    ...
    "ui": {
      ...
      "version": "适用版本 v4.4.0（build 54）· 2026 年 9 月 19 日",
      "tocTitle": "目录",
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "台式机版窗口左上角会显示版本号（例如 Kairumo v4.4.0），反馈问题时请附上它。"
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "怎么反馈问题？",
            "请附上台式机版窗口左上角显示的版本号（例如 Kairumo v4.4.0）与操作步骤。"
          ],
          [
            "同一本笔记可以混用不同的页面格式吗？",
  ...
  "ja": {
    ...
    "ui": {
      ...
      "version": "対象バージョン v4.4.0（build 54）· 2026年9月19日",
      "tocTitle": "目次",
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "デスクトップ版ではウインドウのタイトルにバージョン（例：Kairumo v4.4.0）が表示されます。不具合報告の際は添えてください。"
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "不具合はどう報告しますか？",
            "デスクトップ版のウインドウタイトルに表示されるバージョン（例：Kairumo v4.4.0）と、操作手順を添えてください。"
          ],
          [
  ...
  "ko": {
    ...
    "ui": {
      ...
      "version": "대상 버전 v4.4.0 (build 54) · 2026년 9월 19일",
      "tocTitle": "목차",
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "데스크톱에서는 창 제목에 버전(예: Kairumo v4.4.0)이 표시됩니다. 문제를 알릴 때 함께 적어 주세요."
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "문제는 어떻게 알리나요?",
            "데스크톱 창 제목에 보이는 버전(예: Kairumo v4.4.0)과 진행한 단계를 함께 알려 주세요."
          ],
          [
  ...
  "th": {
    ...
    "ui": {
      ...
      "version": "สำหรับเวอร์ชัน v4.4.0 (build 54) · 19 กันยายน 2026",
      "tocTitle": "สารบัญ",
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "บนเดสก์ท็อป ชื่อหน้าต่างจะแสดงเวอร์ชัน (เช่น Kairumo v4.4.0) โปรดแจ้งมาด้วยเมื่อรายงานปัญหา"
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "รายงานปัญหาอย่างไร",
            "โปรดแจ้งเวอร์ชันที่แสดงบนชื่อหน้าต่างของเดสก์ท็อป (เช่น Kairumo v4.4.0) พร้อมขั้นตอนที่ทำ"
          ],
          [
