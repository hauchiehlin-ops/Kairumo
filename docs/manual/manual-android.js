...
window.KAIRUMO_MANUAL = {
  ...
  "zh-Hant": {
    ...
    "ui": {
      ...
      "version": "適用版本 v4.3.7（build 48）· 2026 年 9 月 19 日",
      "tocTitle": "目錄",
    ...
    "sections": [
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "怎麼回報問題？",
            "請附上版本號（在設定的「關於 Kairumo」查看，例如 Kairumo v4.3.7）與操作步驟。"
          ],
          [
            "同一本筆記可以混用不同的頁面格式嗎？",
  ...
  "en": {
    ...
    "ui": {
      ...
      "version": "For version 4.3.7 (build 48) · 19 September 2026",
      "tocTitle": "Contents",
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "Find the version number in the app's About screen (for example Kairumo v4.3.7) and include it when you report a problem."
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            ...
            "Include the version number (found in the app's About screen, for example Kairumo v4.3.7) and the steps you took."
          ],
          [
  ...
  "zh-Hans": {
    ...
    "ui": {
      ...
      "version": "适用版本 v4.3.7（build 48）· 2026 年 9 月 19 日",
      "tocTitle": "目录",
    ...
    "sections": [
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "怎么反馈问题？",
            "请附上台式机版窗口左上角显示的版本号（例如 Kairumo v4.3.7）与操作步骤。"
          ],
          [
            "同一本笔记可以混用不同的页面格式吗？",
  ...
  "ja": {
    ...
    "ui": {
      ...
      "version": "対象バージョン v4.3.7（build 48）· 2026年9月19日",
      "tocTitle": "目次",
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "アプリの「設定」→「Kairumo について」でバージョン番号（例：Kairumo v4.3.7）を確認できます。不具合報告の際は添えてください。"
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "不具合はどう報告しますか？",
            "アプリの「設定」→「Kairumo について」で確認できるバージョン（例：Kairumo v4.3.7）と、操作手順を添えてください。"
          ],
          [
  ...
  "ko": {
    ...
    "ui": {
      ...
      "version": "대상 버전 v4.3.7 (build 48) · 2026년 9월 19일",
      "tocTitle": "목차",
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "앱 내 정보 화면에서 버전(예: Kairumo v4.3.7)을 확인할 수 있습니다. 문제를 알릴 때 함께 적어 주세요."
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "문제는 어떻게 알리나요?",
            "데스크톱 창 제목에 보이는 버전(예: Kairumo v4.3.7)과 진행한 단계를 함께 알려 주세요."
          ],
          [
  ...
  "th": {
    ...
    "ui": {
      ...
      "version": "สำหรับเวอร์ชัน v4.3.7 (build 48) · 19 กันยายน 2026",
      "tocTitle": "สารบัญ",
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "ดูหมายเลขเวอร์ชัน (เช่น Kairumo v4.3.7) ได้ในหน้า 'เกี่ยวกับ Kairumo' ในการตั้งค่า โปรดแจ้งมาด้วยเมื่อรายงานปัญหา"
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "รายงานปัญหาอย่างไร",
            "โปรดแจ้งเวอร์ชัน (ดูได้ที่หน้า 'เกี่ยวกับ Kairumo' ในการตั้งค่า เช่น Kairumo v4.3.7) พร้อมขั้นตอนที่ทำ"
          ],
          [
