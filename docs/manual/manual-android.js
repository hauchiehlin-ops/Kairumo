...
window.KAIRUMO_MANUAL = {
  ...
  "zh-Hant": {
    ...
    "ui": {
      ...
      "version": "適用版本 v4.10.0（build 64）· 2026 年 9 月 19 日",
      "tocTitle": "目錄",
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "在設定頁面的「關於 Kairumo」可查看版本號（例如 v4.10.0），回報問題時請附上它。"
        ],
      ...
      },
      {
        ...
        "steps": [
          ...
          "手掌放在螢幕上會留下線條時，調「掌拒靈敏度」：切到手繪模式，工具列上就有這顆按鈕（調過之後它會亮著）。用兩支滑桿調「接觸半徑門檻」與「筆落下時的收回時間窗」。**調壞了按「恢復預設」** —— 半徑調太低連筆尖都會被當成手掌，那時候畫布上什麼都畫不出來。"
        ],
      ...
      },
      {
        ...
        "steps": [
          "在平板或大螢幕裝置上，用系統的分割畫面把 Kairumo 與相簿（或檔案、瀏覽器）並排。",
          ...
          "在折疊螢幕裝置半折立起或開啟「立起懸停模式」時，上半部作為筆記清晰瀏覽區，下半部自動展開為沉浸式觸控創作工作盤，方便雙手握持操控筆刷、顏色、磁吸與錨定。"
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "怎麼回報問題？",
            "請附上版本號（在設定的「關於 Kairumo」查看，例如 Kairumo v4.10.0）與操作步驟。"
          ],
          [
            "同一本筆記可以混用不同的頁面格式嗎？",
  ...
  "en": {
    ...
    "ui": {
      ...
      "version": "For version 4.10.0 (build 64) · 19 September 2026",
      "tocTitle": "Contents",
    ...
    "sections": [
      {
        ...
        "buttons": [],
        "steps": [
          "Works on tablets and phones. A stylus feels best, but a finger works fine too.",
          ...
          "Find the version number in the app's About screen (for example Kairumo v4.10.0) and include it when you report a problem."
        ],
      ...
      },
      {
        ...
        "steps": [
          "On a tablet or a large-screen device, use the system's split screen to put Kairumo next to your photo library (or files, or a browser).",
          ...
          "When half-folding a foldable device or enabling “Tabletop / Flex Mode”, the upper screen serves as a clean viewing area while the bottom transforms into an immersive touch creation deck for comfortable two-handed operation."
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            ...
            "Include the version number (found in the app's About screen, for example Kairumo v4.10.0) and the steps you took."
          ],
          [
  ...
  "zh-Hans": {
    ...
    "ui": {
      ...
      "version": "适用版本 v4.10.0（build 64）· 2026 年 9 月 19 日",
      "tocTitle": "目录",
    ...
    "sections": [
      ...
      },
      {
        ...
        "steps": [
          ...
          "手掌放在屏幕上会留下线条时，调「掌拒灵敏度」：切到手绘模式，工具列上就有这颗按钮（调过之后它会亮着）。用两支滑杆调「接触半径阈值」与「笔落下时的收回时间窗」。**调坏了按「恢复默认」** —— 半径调太低连笔尖都会被当成手掌，那时候画布上什么都画不出来。"
        ],
      ...
      },
      {
        ...
        "steps": [
          "在平板或大屏设备上，用系统的分屏把 Kairumo 与相册（或文件、浏览器）并排。",
          ...
          "在折叠屏设备半折立起或开启“立起悬停模式”时，上半部作为笔记清晰浏览区，下半部自动展开为沉浸式触控创作工作盘，方便双手握持操控笔刷、颜色、磁吸与锚定。"
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "怎么反馈问题？",
            "请附上版本号（在设置的「关于 Kairumo」查看，例如 Kairumo v4.10.0）与操作步骤。"
          ],
          [
            "同一本笔记可以混用不同的页面格式吗？",
  ...
  "ja": {
    ...
    "ui": {
      ...
      "version": "対象バージョン v4.10.0（build 64）· 2026年9月19日",
      "tocTitle": "目次",
    ...
    "sections": [
      {
        ...
        "buttons": [],
        "steps": [
          "タブレット・スマートフォンに対応。スタイラスが最適ですが、指でも書けます。",
          ...
          "アプリの「設定」→「Kairumo について」でバージョン番号（例：Kairumo v4.10.0）を確認できます。不具合報告の際は添えてください。"
        ],
      ...
      },
      {
        ...
        "steps": [
          ...
          "手のひらを置くと線が残る場合は「パームリジェクション」を調整します。手書きモードに切り替えると、ツールバーにそのボタンがあります（変更後はハイライト表示されます）。「接触半径のしきい値」と「ペンが触れたときの取り消し時間」の 2 つのスライダーで調整してください。**おかしくなったら「既定に戻す」を押します** —— 半径を下げすぎるとペン先まで手のひらと判定され、何も描けなくなります。"
        ],
      ...
      },
      {
        ...
        "steps": [
          "タブレットや大画面端末では、システムの分割表示で Kairumo と写真（またはファイル、ブラウザ）を並べます。",
          ...
          "折りたたみ端末を半折りに立てるか「テーブルトップ／フレックスモード」にすると、上半分が閲覧エリア、下半分が没入型の創作コントロールデッキに切り替わり、両手持ちで快適にペンや色の操作ができます。"
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "不具合はどう報告しますか？",
            "アプリの「設定」→「Kairumo について」で確認できるバージョン（例：Kairumo v4.10.0）と、操作手順を添えてください。"
          ],
          [
  ...
  "ko": {
    ...
    "ui": {
      ...
      "version": "대상 버전 v4.10.0 (build 64) · 2026년 9월 19일",
      "tocTitle": "목차",
    ...
    "sections": [
      {
        ...
        "buttons": [],
        "steps": [
          "태블릿과 스마트폰에서 사용할 수 있습니다. 스타일러스가 가장 자연스럽지만, 손가락도 됩니다.",
          ...
          "앱 내 정보 화면에서 버전(예: Kairumo v4.10.0)을 확인할 수 있습니다. 문제를 알릴 때 함께 적어 주세요."
        ],
      ...
      },
      {
        ...
        "steps": [
          ...
          "손바닥을 올렸을 때 선이 남는다면 “손바닥 인식 차단”을 조정하세요. 필기 모드로 전환하면 도구 막대에 해당 버튼이 있습니다(한 번 변경하면 계속 강조 표시됩니다). “접촉 반경 임계값”과 “펜이 닿을 때 되돌릴 시간” 두 슬라이더로 조정합니다. **잘못되면 “기본값 복원”을 누르세요** — 반경을 너무 낮추면 펜촉까지 손바닥으로 인식되어 아무것도 그려지지 않습니다."
        ],
      ...
      },
      {
        ...
        "steps": [
          "태블릿이나 대화면 기기에서 시스템의 화면 분할로 Kairumo와 사진 보관함(또는 파일, 브라우저)을 나란히 둡니다.",
          ...
          "폴더블 기기를 반으로 접어 세우거나 “테이블탑 / 플렉스 모드”를 활성화하면 상단은 선명한 노트 열람 영역으로, 하단은 펜·색상·스냅 등을 양손으로 편안하게 조작할 수 있는 몰입형 컨트롤 데스크로 전환됩니다."
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "문제는 어떻게 알리나요?",
            "앱 내 정보 화면에서 확인한 버전(예: Kairumo v4.10.0)과 진행한 단계를 함께 알려 주세요."
          ],
          [
  ...
  "th": {
    ...
    "ui": {
      ...
      "version": "สำหรับเวอร์ชัน v4.10.0 (build 64) · 19 กันยายน 2026",
      "tocTitle": "สารบัญ",
    ...
    "sections": [
      {
        ...
        "buttons": [],
        "steps": [
          "ใช้ได้บนแท็บเล็ตและโทรศัพท์ เขียนด้วยสไตลัสลื่นที่สุด แต่ใช้นิ้วก็ได้",
          ...
          "ดูหมายเลขเวอร์ชัน (เช่น Kairumo v4.10.0) ได้ในหน้า 'เกี่ยวกับ Kairumo' ในการตั้งค่า โปรดแจ้งมาด้วยเมื่อรายงานปัญหา"
        ],
      ...
      },
      {
        ...
        "steps": [
          ...
          "หากวางฝ่ามือแล้วเกิดรอยเส้น ให้ปรับ “การปฏิเสธฝ่ามือ” สลับไปโหมดวาดมือ แล้วปุ่มนี้จะอยู่บนแถบเครื่องมือ (จะสว่างค้างไว้เมื่อคุณปรับแล้ว) ปรับด้วยแถบเลื่อนสองอัน คือ “เกณฑ์รัศมีการสัมผัส” และ “ช่วงเวลาย้อนกลับเมื่อปากกาแตะ” **หากผิดพลาดให้กด “คืนค่าเริ่มต้น”** เพราะถ้าตั้งรัศมีต่ำเกินไป ปลายปากกาจะถูกมองว่าเป็นฝ่ามือ และจะวาดอะไรไม่ได้เลย"
        ],
      ...
      },
      {
        ...
        "buttons": [
          "โหมดตั้งโต๊ะ / เฟล็กซ์"
        ],
        "steps": [
          "บนแท็บเล็ตหรืออุปกรณ์หน้าจอใหญ่ ใช้การแบ่งหน้าจอของระบบเพื่อวาง Kairumo ไว้ข้างคลังรูปภาพ (หรือไฟล์ หรือเบราว์เซอร์)",
          ...
          "เมื่อตั้งอุปกรณ์จอพับครึ่งหนึ่งหรือเปิด “โหมดตั้งโต๊ะ / เฟล็กซ์” หน้าจอครึ่งบนจะเป็นพื้นที่ดูบันทึกที่ชัดเจน ส่วนครึ่งล่างจะเปลี่ยนเป็นแผงควบคุมระบบสัมผัสสำหรับการวาดเขียนและเลือกสีอย่างสะดวกสบาย"
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "รายงานปัญหาอย่างไร",
            "โปรดแจ้งเวอร์ชัน (ดูได้ที่หน้า 'เกี่ยวกับ Kairumo' ในการตั้งค่า เช่น Kairumo v4.10.0) พร้อมขั้นตอนที่ทำ"
          ],
          [
