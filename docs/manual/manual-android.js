    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "在設定頁面的「關於 Kairumo」可查看版本號（例如 v4.2.1），回報問題時請附上它。"
        ],
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "Find the version number in the app's About screen (for example Kairumo v4.2.1) and include it when you report a problem."
        ],
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "在设置页面的「关于 Kairumo」可查看版本号（例如 v4.2.1），反馈问题时请附上它。"
        ],
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "アプリの「設定」→「Kairumo について」でバージョン番号（例：Kairumo v4.2.1）を確認できます。不具合報告の際は添えてください。"
        ],
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "앱 내 정보 화면에서 버전(예: Kairumo v4.2.1)을 확인할 수 있습니다. 문제를 알릴 때 함께 적어 주세요."
        ],
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "ดูหมายเลขเวอร์ชัน (เช่น Kairumo v4.2.1) ได้ในหน้า 'เกี่ยวกับ Kairumo' ในการตั้งค่า โปรดแจ้งมาด้วยเมื่อรายงานปัญหา"
        ],
