...
window.KAIRUMO_MANUAL = {
  ...
  "zh-Hant": {
    ...
    "ui": {
      ...
      "version": "適用版本 v4.2.1（build 40）· 2026 年 9 月 19 日",
      "tocTitle": "目錄",
  ...
  "en": {
    ...
    "ui": {
      ...
      "version": "For version 4.2.1 (build 40) · 19 September 2026",
      "tocTitle": "Contents",
  ...
  "zh-Hans": {
    ...
    "ui": {
      ...
      "version": "适用版本 v4.2.1（build 40）· 2026 年 9 月 19 日",
      "tocTitle": "目录",
    ...
    "sections": [
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "怎么反馈问题？",
            "请附上台式机版窗口左上角显示的版本号（例如 Kairumo v4.2.1）与操作步骤。"
          ],
          [
            "同一本笔记可以混用不同的页面格式吗？",
  ...
  "ja": {
    ...
    "ui": {
      ...
      "version": "対象バージョン v4.2.1（build 40）· 2026年9月19日",
      "tocTitle": "目次",
  ...
  "ko": {
    ...
    "ui": {
      ...
      "version": "대상 버전 v4.2.1 (build 40) · 2026년 9월 19일",
      "tocTitle": "목차",
    ...
    "sections": [
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "문제는 어떻게 알리나요?",
            "데스크톱 창 제목에 보이는 버전(예: Kairumo v4.2.1)과 진행한 단계를 함께 알려 주세요."
          ],
          [
  ...
  "th": {
    ...
    "ui": {
      ...
      "version": "สำหรับเวอร์ชัน v4.2.1 (build 40) · 19 กันยายน 2026",
      "tocTitle": "สารบัญ",
