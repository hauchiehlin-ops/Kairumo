    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "桌機版視窗左上角會顯示版本號（例如 Kairumo v4.3.2），回報問題時請附上它。"
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "怎麼回報問題？",
            "請附上桌機版視窗左上角顯示的版本號（例如 Kairumo v4.3.2）與操作步驟。"
          ],
          [
            "同一本筆記可以混用不同的頁面格式嗎？",
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "On desktop the window title shows the version (for example Kairumo v4.3.2) — include it when you report a problem."
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            ...
            "Include the version shown in the desktop window title (for example Kairumo v4.3.2) and the steps you took."
          ],
          [
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "台式机版窗口左上角会显示版本号（例如 Kairumo v4.3.2），反馈问题时请附上它。"
        ],
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "デスクトップ版ではウインドウのタイトルにバージョン（例：Kairumo v4.3.2）が表示されます。不具合報告の際は添えてください。"
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "不具合はどう報告しますか？",
            "デスクトップ版のウインドウタイトルに表示されるバージョン（例：Kairumo v4.3.2）と、操作手順を添えてください。"
          ],
          [
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "데스크톱에서는 창 제목에 버전(예: Kairumo v4.3.2)이 표시됩니다. 문제를 알릴 때 함께 적어 주세요."
        ],
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "บนเดสก์ท็อป ชื่อหน้าต่างจะแสดงเวอร์ชัน (เช่น Kairumo v4.3.2) โปรดแจ้งมาด้วยเมื่อรายงานปัญหา"
        ],
      ...
      },
      {
        ...
        "faq": [
          ...
          [
            "รายงานปัญหาอย่างไร",
            "โปรดแจ้งเวอร์ชันที่แสดงบนชื่อหน้าต่างของเดสก์ท็อป (เช่น Kairumo v4.3.2) พร้อมขั้นตอนที่ทำ"
          ],
          [
