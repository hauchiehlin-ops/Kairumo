...
| S-89 | **新樣板還沒有「實務範例／空白大綱」內容** | S-90 把紙張從 13 種擴到 33 種，但 `templates/src/*.json` 裡只有舊的那幾種帶了示範內容（「紙張內容」那一排在新樣板上不會出現）。四象限、KWL、週計畫這類**版面即用法**的紙其實最需要一份填好的範例 —— 使用者看一眼就知道那四格該寫什麼。 |
